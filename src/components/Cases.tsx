...
const Cases: React.FC = () => {
  const allClients = [
    ...
    { name: "Ituran Seguros", niche: "Segurança Veicular", desc: "Líder mundial em rastreamento e tecnologia de recuperação de veículos.", result: "Performance Global", url: "https://ituran.com.br/", customLogo: ituranLogo },
